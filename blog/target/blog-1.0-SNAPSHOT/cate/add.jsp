...
<div class="container mt-5">
    ...
    <div class="row">
        <div class="col"></div>
        <div class="col"><h1>添加类别</h1></div>
        <div class="col"></div>
    </div>
    <div class="row">
        <div class="col-12">
            <form action="${pageContext.request.contextPath}/cate/add" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="cateNumber" id="cateNumber" value="0">
                    </div>
                </div>
                <div class="form-group row">
